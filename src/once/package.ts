...
import { ok, createWorkflow } from "big-config/core";
...
const START = "io.github.bigconfig-ai.once.package/start";
const END = "io.github.bigconfig-ai.once.package/end";
const PIPELINE_START = "io.github.bigconfig-ai.once.package/start-create-or-delete";
const PIPELINE_END = "io.github.bigconfig-ai.once.package/end-create-or-delete";
...
export function once(sfns: StepFn[], opts0: Opts): Opts {
