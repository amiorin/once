...
source "/home/ubuntu/code/bigconfig/once/python/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/tmp/devenv-reload-974763.sh" ]; then
        ...
        source "/tmp/devenv-reload-974763.sh"
        rm -f "/tmp/devenv-reload-974763.sh"
