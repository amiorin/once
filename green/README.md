...
provider-compute: digitalocean  # azure, aws, digitalocean, hcloud, yandex, oci, no-infra
...
- Compute templates: Azure, AWS, DigitalOcean, Hetzner Cloud, Yandex Cloud, OCI, and an
